...
-	**Name:** core/group
-	**Category:** design
-	**Supports:** align (full, wide), anchor, ariaLabel, color (background, gradients, link, text), meta, spacing (blockGap, margin, padding), typography (fontSize, lineHeight), ~~html~~
